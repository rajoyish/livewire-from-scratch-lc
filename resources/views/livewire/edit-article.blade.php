            ...
            <div class="mt-12">
                ...
                <form wire:submit="save">
                    <div class="grid gap-4 lg:gap-6">
                        <div>
                            <label wire:dirty.class="text-orange-700" wire:target="form.title"
                                for="hs-work-email-hire-us-2"
                                class="block mb-2 text-sm text-gray-700 font-medium dark:text-white">
                                News Title<span wire:dirty wire:target="form.title">*</span>
                            </label>
                        ...
                        <div>
                            <label wire:dirty.class="text-orange-700" wire:target="form.content"
                    ...
                    <div class="flex my-6">
                        ...
                        <label wire:dirty.class="text-orange-700" wire:target="form.published" for="hs-default-checkbox"
                            class="text-sm text-gray-500 ms-3 dark:text-neutral-400">
                            Set as Published<span wire:dirty wire:target="form.published">*</span>
                        </label>
                    </div>
                    <div class="space-y-4">
                        <label wire:dirty.class="text-orange-700" class="font-bold">Need notifications?<span wire:dirty
                                wire:target="form.notifications">*</span></label>
                    ...
                    <div class="mt-6 grid">
                        <button wire:dirty.class="hover:bg-green-900" wire:dirty.remove.attr="disabled" disabled
                            type="submit"
                            class="w-full disabled:bg-green-600 py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-green-600 text-white hover:bg-green-700 focus:outline-none focus:bg-green-700 disabled:opacity-50 disabled:pointer-events-none">
                            Save
                        </button>
                    </div>
                </form>
